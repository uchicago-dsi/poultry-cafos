...
def get_downtown(df):
    ...
    '''
    # Define downtown area using bounding box
    downtown_bbox = (-80.857, 35.215, -80.836, 35.230)
    downtown_polygon = box(*downtown_bbox)
    # match crs
    downtown_gdf = gpd.GeoDataFrame(geometry=[downtown_polygon], crs=df.crs)
    return downtown_gdf
...
def get_water_cover(df):
    ...
    '''
    water_polygon = gpd.read_file('NC_water_bodies.geojson')
